...
//Constantes
#define CPA         5			//Coefficient proportionel pour l'angle
#define CDA         0                   //Coefficient dérivé pour l'angle
#define AT          1e-6		//Angle tolérance = 16,31
#define AA          10			//Angle accélération

#define CP          20			//Coefficient proportionel
#define CD          0                   //Coefficient dérivé
#define DT          1e-6		//Distance tolérance
#define DA          10			//Distance accélération

#define VAMAX       3000		//Vitesse angulaire maximale (max physique 1600)
#define VAMIN       150			//Vitesse angulaire minimale

#define VMAX        3000		//Vitesse maximale (max physique 1600)
