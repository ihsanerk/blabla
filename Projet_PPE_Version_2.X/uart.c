...
void uart_init() {
    ...
    IFS1bits.U2RXIF = 0; //clear interruption flag
    IEC1bits.U2RXIE = 1; // Enable interruption
    ...
    */
    ...
    RPOR5bits.RP82R = 3; // RP127 : le pin 73 sur dsPic33e
...
void __attribute__((__interrupt__, auto_psv)) _U2TXInterrupt(void) {
    ...
    {
        case'g':
                StringFormatted(" G :%d  ",codeurGetGauche());
            break;
        case 'd':
                StringFormatted(" D :%d  ",codeurGetDroit());
            break;
    }*/
